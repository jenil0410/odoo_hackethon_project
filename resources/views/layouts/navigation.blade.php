<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    @php
        $canRead = static fn (string $module) => \App\Models\Permission::checkCRUDPermissionToUser($module, 'read');
    @endphp
    ...
    <ul class="menu-inner py-1">
        ...
        @if ($canRead('Operational Analytics'))
