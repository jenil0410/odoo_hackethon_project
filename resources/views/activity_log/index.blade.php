    ...
    $(document).ready(function() {
        ...
        function fill_datatable() {
            ...
            dataTable = $('#donation_table').DataTable({
                ...
                sorting: false,
                ordering: false,
                dom: '<"flex-column flex-md-row"<"head-label text-center"><"dt-action-buttons text-end pt-3 pt-md-0"B>><"row"<"col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-end"f>>t',
